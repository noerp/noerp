...
under the License.
-->
<#assign appModelMenu = Static["org.noerp.widget.model.MenuFactory"].getMenuFromLocation(applicationMenuLocation,applicationMenuName)>
...
<#if parameters.portalPageId?has_content && !appModelMenu.getModelMenuItemByName(headerItem)?? && userLogin??>
    <#assign findMap = Static["org.noerp.base.util.UtilMisc"].toMap("portalPageId", parameters.portalPageId)>
