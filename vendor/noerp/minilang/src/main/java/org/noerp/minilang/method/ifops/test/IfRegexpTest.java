 ...
 * under the License.
 *******************************************************************************/
package org.noerp.minilang.method.ifops.test;
...
import org.noerp.minilang.method.MethodContext;
    ...
    private static class MyThread extends Thread {
        ...
        public void run() {
            ...
            while (!stopNow) {
                ...
                try {
                    tryCount++;
                    String responseCode = SimpleMethod.runSimpleMethod("component://minilang/script/org/noerp/minilang/method/ifops/IfRegexpTests.xml", "testIfRegexp", methodContext);
