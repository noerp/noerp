 ...
 * under the License.
 *******************************************************************************/
package org.noerp.entityext.data;
...
import org.noerp.base.container.Container;
...
import org.noerp.entity.util.EntityDataLoader;
...
public class EntityDataLoadContainer implements Container {
    ...
    public void init(String[] args, String name, String configFile) throws ContainerException {
        ...
        /*
           load-data arguments:
           readers (none, all, seed, demo, ext, etc - configured in entityengine.xml and associated via component.xml)
           ...
           Example:
           $ java -jar noerp.jar -load-data -readers=seed,demo,ext -timeout=7200 -delegator=default -group=org.noerp
           $ java -jar noerp.jar -load-data -file=/tmp/dataload.xml
    ...
    /**
     * @see org.noerp.base.container.Container#start()
     */
    @Override
    ...
    /**
     * @see org.noerp.base.container.Container#stop()
     */
    @Override
