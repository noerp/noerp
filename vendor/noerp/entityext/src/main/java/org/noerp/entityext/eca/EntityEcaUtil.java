 ...
 * under the License.
 *******************************************************************************/
package org.noerp.entityext.eca;
...
import org.noerp.entity.config.model.EntityEcaReader;
...
public class EntityEcaUtil {
    ...
    protected static void readConfig(String entityEcaReaderName, Map<String, Map<String, List<EntityEcaRule>>> ecaCache) {
        ...
        // get all of the component resource eca stuff, ie specified in each component.xml file
