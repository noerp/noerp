 ...
 * jsse.properties
 * noerp-base.jar
 * noerp-service-rmi.jar (copied and renamed from "noerp/framework/service/build/lib/noerp-service-rmi.raj" from an OFBiz build)
 *
 ...
 * log4j.jar
 *
 * Copy the truststore file framework/base/config/noerprmi-truststore.jks to the client
 *
 * Run the client specifying the path to the client truststore: -Djavax.net.ssl.trustStore=noerprmi-truststore.jks
 *
 */
