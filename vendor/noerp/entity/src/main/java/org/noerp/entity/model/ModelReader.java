 ...
 * under the License.
 *******************************************************************************/
package org.noerp.entity.model;
...
import org.noerp.base.config.GenericConfigException;
import org.noerp.base.config.MainResourceHandler;
import org.noerp.base.config.ResourceHandler;
import org.noerp.base.util.Debug;
import org.noerp.base.util.UtilTimer;
import org.noerp.base.util.UtilValidate;
import org.noerp.base.util.UtilXml;
import org.noerp.base.util.cache.UtilCache;
import org.noerp.entity.GenericEntityConfException;
...
import org.noerp.entity.config.model.EntityModelReader;
import org.noerp.entity.config.model.Resource;
...
public class ModelReader implements Serializable {
    ...
    private ModelReader(String modelName) throws GenericEntityException {
        ...
        // get all of the component resource model stuff, ie specified in each component.xml file
