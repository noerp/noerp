 ...
 * under the License.
 *******************************************************************************/
package org.noerp.entity.config.model;
...
import org.noerp.base.lang.ThreadSafe;
...
public final class DelegatorElement {
    ...
    DelegatorElement(Element element) throws GenericEntityConfException {
        ...
        if (entityEcaHandlerClassName.isEmpty()) {
            entityEcaHandlerClassName = "org.noerp.entityext.eca.DelegatorEcaHandler";
        }
        ...
        if (distributedCacheClearClassName.isEmpty()) {
            distributedCacheClearClassName = "org.noerp.entityext.cache.EntityCacheServices";
        }
