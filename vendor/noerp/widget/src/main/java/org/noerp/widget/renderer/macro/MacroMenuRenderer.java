...
import org.noerp.widget.model.CommonWidgetModels.Image;
import org.noerp.widget.model.ModelMenu;
import org.noerp.widget.model.ModelMenuItem;
import org.noerp.widget.model.ModelMenuItem.MenuLink;
...
public class MacroMenuRenderer implements MenuStringRenderer {
    ...
    private Map<String, Object> createImageParameters(Map<String, Object> context, Image image) {
        ...
        if (UtilValidate.isNotEmpty(src) && request != null && response != null) {
            ...
            if ("noerp".equalsIgnoreCase(urlMode)) {
