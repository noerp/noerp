 ...
 * under the License.
 *******************************************************************************/
package org.noerp.widget.renderer;
...
import org.noerp.widget.cache.GenericWidgetOutput;
import org.noerp.widget.cache.ScreenCache;
import org.noerp.widget.cache.WidgetContextCacheKey;
import org.noerp.widget.model.ModelScreen;
import org.noerp.widget.model.ScreenFactory;
...
public class ScreenRenderer {
     ...
     * Renders the named screen using the render environment configured when this ScreenRenderer was created.
     *
     * @param resourceName The name/location of the resource to use, can use "component://[component-name]/" and "noerp://" and other special OFBiz style URLs
