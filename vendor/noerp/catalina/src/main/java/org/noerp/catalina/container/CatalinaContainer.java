 ...
 * under the License.
 *******************************************************************************/
package org.noerp.catalina.container;
...
import org.noerp.base.container.ContainerConfig.Container.Property;
...
import org.noerp.base.util.SSLUtil;
...
public class CatalinaContainer implements Container {
    ...
    public static final String CATALINA_HOSTS_HOME = System.getProperty("noerp.home") + "/vendor/noerp/catalina/hosts";
    public static final String J2EE_SERVER = "NoERP Container 3.1";
    public static final String J2EE_APP = "NoERP";
    ...
    public void init(String[] args, String name, String configFile) throws ContainerException {
        ...
        // set catalina_home
        System.setProperty(Globals.CATALINA_HOME_PROP, System.getProperty("noerp.home") + "/" + this.catalinaRuntimeHome);
        ...
        tomcat = new Tomcat();
        tomcat.setBaseDir(System.getProperty("noerp.home"));
    ...
    private Engine createEngine(ContainerConfig.Container.Property engineConfig) throws ContainerException {
        ...
        if (logDir != null) {
            ...
            if (!logDir.startsWith("/")) {
                logDir = System.getProperty("noerp.home") + "/" + logDir;
            }
