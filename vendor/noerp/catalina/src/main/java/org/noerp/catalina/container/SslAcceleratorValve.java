...
/**
 * To use add (or uncomment) the following line to the Tomcat/Catalina configuarion (ie in noerp-containers.xml under the <property name="default-server" value="engine"> element)
