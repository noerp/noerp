...
public class UtilCodecTests  extends GenericTestCaseBase {
    ...
    public void testCheckStringForHtmlStrictNone() {
        ...
        checkStringForHtmlStrictNone_test("double-encoding", "%2%353Cscript", "%2%353Cscript", "In field [double-encoding] found character escaping (mixed or double) that is not allowed or other format consistency error: org.noerp.base.util.UtilCodec$IntrusionException: Input validation failure");
    }
