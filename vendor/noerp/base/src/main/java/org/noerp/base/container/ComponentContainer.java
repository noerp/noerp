 ...
 * under the License.
 *******************************************************************************/
package org.noerp.base.container;
...
import org.noerp.base.component.AlreadyLoadedException;
import org.noerp.base.component.ComponentConfig;
import org.noerp.base.component.ComponentException;
import org.noerp.base.component.ComponentLoaderConfig;
 ...
 * <p/>
 * Example noerp-container.xml configuration:
 * <pre>
 *   <container name="component-container" class="org.noerp.base.component.ComponentContainer"/>
 * </pre>
 */
public class ComponentContainer implements Container {
    ...
    public synchronized void loadComponents(String loaderConfig) throws AlreadyLoadedException, ComponentException {
        ...
        String parentPath;
        try {
            parentPath = FileUtil.getFile(System.getProperty("noerp.home")).getCanonicalFile().toString().replaceAll("\\\\", "/");
                ...
                for (String sub: fileNames) {
                    try {
                        ...
                        if (componentPath.isDirectory() && !sub.equals("CVS") && !sub.equals(".svn")) {
                            ...
                            File configFile = FileUtil.getFile(componentLocation + "/component.xml");
