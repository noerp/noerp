...
import org.noerp.base.start.Config;
import org.noerp.base.start.StartupException;
import org.noerp.base.start.StartupLoader;
...
public class ContainerLoader implements StartupLoader {
    ...
    /**
     * @see org.noerp.base.start.StartupLoader#load(Config, String[])
     */
    @Override
    ...
    /**
     * @see org.noerp.base.start.StartupLoader#start()
     */
    @Override
    ...
    /**
     * @see org.noerp.base.start.StartupLoader#unload()
     */
    @Override
