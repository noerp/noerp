 ...
 * under the License.
 *******************************************************************************/
package org.noerp.webapp.control;
...
import org.noerp.webapp.event.RequestBodyMapHandlerFactory;
...
public class ContextFilter implements Filter {
    ...
    protected void putAllInitParametersInAttributes() {
        ...
        if (UtilValidate.isNotEmpty(GeronimoMultiOfbizInstances)) {
            ...
            if (GeronimoMultiOfbizInstances.equalsIgnoreCase("true") && UtilValidate.isEmpty(noerpHome)) {
                noerpHome = System.getProperty("noerp.home"); // This is only used in case of Geronimo or WASCE using OFBiz multi-instances. It allows to retrieve noerp.home value set in JVM env
    ...
    protected String getServerId() {
        ...
        if (serverId == null) {
            serverId = config.getServletContext().getInitParameter("noerpServerName");
