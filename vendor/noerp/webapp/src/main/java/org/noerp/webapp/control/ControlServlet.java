...
import org.noerp.entity.GenericDelegator;
...
import org.noerp.webapp.stats.ServerHitBin;
import org.noerp.webapp.stats.VisitHandler;
...
public class ControlServlet extends HttpServlet {
    ...
    protected void configureBsf() {
        ...
        BSFManager.registerScriptingEngine("beanshell", "org.noerp.base.util.OfbizBshBsfEngine", bshExtensions);

        String[] jsExtensions = {"js"};
        BSFManager.registerScriptingEngine("javascript", "org.noerp.base.util.OfbizJsBsfEngine", jsExtensions);

        String[] smExtensions = {"sm"};
        BSFManager.registerScriptingEngine("simplemethod", "org.noerp.minilang.SimpleMethodBsfEngine", smExtensions);
    }
