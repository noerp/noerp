...
import org.noerp.entity.model.ModelIndex;
...
import org.noerp.entityext.EntityGroupUtil;
...
import org.noerp.webtools.artifactinfo.ArtifactInfoFactory;
import org.noerp.webtools.artifactinfo.ServiceArtifactInfo;
...
public class WebToolsServices {
    ...
    public static Map<String, Object> entityImport(DispatchContext dctx, Map<String, ? extends Object> context) {
        ...
        if (UtilValidate.isNotEmpty(fmfilename) && (UtilValidate.isNotEmpty(fulltext) || url != null)) {
            ...
            try {
                Configuration conf = org.noerp.base.util.template.FreeMarkerWorker.getDefaultOfbizConfig();
    ...
    public static Map<String, Object> entityImportReaders(DispatchContext dctx, Map<String, Object> context) {
        ...
        String groupNameToUse = overrideGroup != null ? overrideGroup : "org.noerp";
            ...
            for (String pName : packageNames) {
                ...
                for (String entityName: entities) {
                    ...
                    if (search == null || entityName.toLowerCase().indexOf(search.toLowerCase()) != -1) {
                        ...
                        entityLocation = entityLocation.replaceFirst(System.getProperty("noerp.home") + "/", "");
